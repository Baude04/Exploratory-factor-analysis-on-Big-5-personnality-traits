...
If you only want to see the plots and results of the analysis, without obtaining the `IPIP-50_FFM_factor_scores.csv` file, please take a look at `factor_analysis.html` (just download it and open it on your navigator).
